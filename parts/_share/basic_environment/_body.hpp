...
namespace elc::defs{
	...
	namespace basic_environment{
		...
		//任意类型转算数类型
		template<class T>
		inline constexpr bool is_arithmetic_convertible_able_helper()noexcept{
		...
		template<class T>
		inline constexpr bool is_arithmetic_convertible_unique_helper()noexcept{
		...
		template<class T>
		inline constexpr bool is_arithmetic_convertible_helper_final()noexcept{
		...
		template<class T>
		inline constexpr bool is_arithmetic_convertible= is_arithmetic_convertible_helper_final<T>();
		//算数类型转任意类型
