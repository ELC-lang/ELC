...
public:
	[[nodiscard]]virtual explicit operator logical_bool()const{return false;}
}nil{};

[[nodiscard]]constexpr node_like*get_null_ptr(type_info_t<node_like>)noexcept{return address_of(nil);}
